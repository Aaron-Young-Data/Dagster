...
from .dnn_f1_predictor import dnn_model_assets, dnn_predictor_assets
...
F1_DNN_MODEL = 'DNN_model_creation'
f1_dnn_model_assets = load_assets_from_package_module(package_module=dnn_f1_predictor,
                                                      group_name=F1_DNN_MODEL)
