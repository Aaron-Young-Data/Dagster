...
SELECT
    ...
    CASE WHEN SESSION_CD = 'Practice 1' THEN COM.COMPOUND_CD END AS COMPOUND_FP1,
    ...
    CASE WHEN SESSION_CD = 'Practice 2' THEN COM.COMPOUND_CD END AS COMPOUND_FP2,
    ...
    CASE WHEN SESSION_CD = 'Practice 3' THEN COM.COMPOUND_CD END AS COMPOUND_FP3,
    ...
    CASE WHEN SESSION_CD = 'Qualifying' THEN COM.COMPOUND_CD END AS COMPOUND_Q,
