SELECT
	...
	DAT.RAINFALL_FP3,
    DAT.TRACK_TEMP_FP3,
    IFNULL(FCST.TEMPERATURE, 0) AS AIR_TEMP_Q,
    CASE WHEN IFNULL(FCST.PRECIPITATION_PROB, 0) > 60 THEN 1 ELSE 0 END AS RAINFALL_Q,
    CASE WHEN EVENT_TYPE_CD = 1 THEN 0 ELSE 1 END AS IS_SPRINT,
	TRK.TRACTION,
    TRK.TYRE_STRESS,
    TRK.ASPHALT_GRIP,
    TRK.BRAKING,
