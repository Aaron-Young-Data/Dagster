SELECT
        ...
        CASE WHEN DAT.COMPOUND_FP1 = 1 THEN 1 ELSE 0 END AS SOFT_COMPOUND_FP1,
        CASE WHEN DAT.COMPOUND_FP1 = 2 THEN 1 ELSE 0 END AS MEDIUM_COMPOUND_FP1,
        CASE WHEN DAT.COMPOUND_FP1 = 3 THEN 1 ELSE 0 END AS HARD_COMPOUND_FP1,
        CASE WHEN DAT.COMPOUND_FP1 = 4 THEN 1 ELSE 0 END AS INTERMEDIATE_COMPOUND_FP1,
        CASE WHEN DAT.COMPOUND_FP1 = 5 THEN 1 ELSE 0 END AS WET_COMPOUND_FP1,
        ...
        CASE WHEN DAT.COMPOUND_FP2 = 1 THEN 1 ELSE 0 END AS SOFT_COMPOUND_FP2,
        CASE WHEN DAT.COMPOUND_FP2 = 2 THEN 1 ELSE 0 END AS MEDIUM_COMPOUND_FP2,
        CASE WHEN DAT.COMPOUND_FP2 = 3 THEN 1 ELSE 0 END AS HARD_COMPOUND_FP2,
        CASE WHEN DAT.COMPOUND_FP2 = 4 THEN 1 ELSE 0 END AS INTERMEDIATE_COMPOUND_FP2,
        CASE WHEN DAT.COMPOUND_FP2 = 5 THEN 1 ELSE 0 END AS WET_COMPOUND_FP2,
        ...
        CASE WHEN DAT.COMPOUND_FP3 = 1 THEN 1 ELSE 0 END AS SOFT_COMPOUND_FP3,
        CASE WHEN DAT.COMPOUND_FP3 = 2 THEN 1 ELSE 0 END AS MEDIUM_COMPOUND_FP3,
        CASE WHEN DAT.COMPOUND_FP3 = 3 THEN 1 ELSE 0 END AS HARD_COMPOUND_FP3,
        CASE WHEN DAT.COMPOUND_FP3 = 4 THEN 1 ELSE 0 END AS INTERMEDIATE_COMPOUND_FP3,
        CASE WHEN DAT.COMPOUND_FP3 = 5 THEN 1 ELSE 0 END AS WET_COMPOUND_FP3,
