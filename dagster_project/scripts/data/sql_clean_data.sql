SELECT
	SNDT.LAPTIME_FP1,
    FP1_COMP.COMPOUND_CD AS COMPOUND_FP1,
    SNDT.AIR_TEMP_FP1,
    SNDT.RAINFALL_FP1,
    SNDT.TRACK_TEMP_FP1,
    IFNULL(SNDT.LAPTIME_FP2, 0) AS LAPTIME_FP2,
    IFNULL(FP2_COMP.COMPOUND_CD, 0) AS COMPOUND_FP2,
    ...
    IFNULL(FP3_COMP.COMPOUND_CD, 0) AS COMPOUND_FP3,
    ...
    TRK.TRACK_EVOLUTION,
    TRK.DOWNFORCE
FROM RAW_SESSION_DATA SNDT
LEFT JOIN DIM_COMPOUND FP1_COMP
	ON SNDT.COMPOUND_FP1 = FP1_COMP.COMPOUND_NAME
LEFT JOIN DIM_COMPOUND FP2_COMP
	ON SNDT.COMPOUND_FP2 = FP1_COMP.COMPOUND_NAME
LEFT JOIN DIM_COMPOUND FP3_COMP
	ON SNDT.COMPOUND_FP3 = FP1_COMP.COMPOUND_NAME
...
SELECT
    ...
    SNDT.TRACK_TEMP_FP1,
    SNDT.LAPTIME_FP2,
    FP2_COMP.COMPOUND_CD AS COMPOUND_FP2,
    SNDT.AIR_TEMP_FP2,
    SNDT.RAINFALL_FP2,
    SNDT.TRACK_TEMP_FP2,
    SNDT.LAPTIME_FP3,
    FP3_COMP.COMPOUND_CD AS COMPOUND_FP3,
    SNDT.AIR_TEMP_FP3,
    SNDT.RAINFALL_FP3,
    SNDT.TRACK_TEMP_FP3,
    SNDT.LAPTIME_Q,
